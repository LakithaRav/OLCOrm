...
// OLCOrm
#define COCOAPODS_POD_AVAILABLE_OLCOrm
#define COCOAPODS_VERSION_MAJOR_OLCOrm 0
#define COCOAPODS_VERSION_MINOR_OLCOrm 0
#define COCOAPODS_VERSION_PATCH_OLCOrm 8
